...
- Introduced the original dark futuristic glassmorphism visual system.
- Added centralized design tokens, responsive styling, semantic status colors, and reduced-motion support.
- Added original MONTE TOP SVG branding and login integration.
- Added a real console Copy Last 100 Lines action backed by live xterm event output and Clipboard API.
- Added safe install, update, uninstall, restore, and build helpers with timestamped backups.
